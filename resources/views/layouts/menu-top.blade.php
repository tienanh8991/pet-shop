            ...
            <form class="navbar-search navbar-search-light form-inline mr-sm-3" method="get"
                ...
                <div class="form-group mb-0">
                    <div class="input-group input-group-alternative input-group-merge">
                        ...
                        <input type="hidden" name="object" value="@yield('object')">
                    </div>
                </div>
            ...
            <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
                <li class="nav-item dropdown">
                  ...
                  <span class="avatar avatar-sm rounded-circle">
                    <img alt="Image placeholder" class="rounded-circle" src="
                                    @if(\Illuminate\Support\Facades\Auth::user()->image)
                                        {{asset('storage/'.\Illuminate\Support\Facades\Auth::user()->image)}}
                                    @else
